...
public class MtCORBA extends CORBAInterfacePOA {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MtCORBA communication = new MtCORBA();
			...
			NameComponent path[] = ncRef.to_name(Utils.MTL_ORB_SERVER);
	...
	public String processRequest(MessageModel model) {
		...
		case REMOVE_EVENT:
			...
			break;
		case LIST_EVENT_AVAILABILITY:
			System.out.println("LIST EVENT AVAILABILITY" + model.getEventType());
		...
		case BOOK_EVENT:
			...
			break;
		case GET_BOOKING_SCHEDULE:
			System.out.println("GET_BOOKING_SCHEDULE" + model.getClientID());
		...
		case CANCEL_EVENT:
			...
			break;
		case SWAP_EVENT:
			response = controller.swapEvent(model.getClientID(), model.getEventID(), model.getEventType(),
					model.getNewEventID(), model.getNewEventType());
			break;
		}
		return response;
	}

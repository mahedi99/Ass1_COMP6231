...
public class EventManagerClientCORBA {
	...
	public EventManagerClientCORBA() {
	...
	public void eventManagerClientRequest(String id) {
		...
		if (requestType == RequestType.ADD_EVENT) {
			...
			emccsc.makeRmiRequestEventManagerAddEvent(managerClientID, requestType, eventID, eventType,
					bookingCapacity);
			...
			while (true) {
			 ...
			 emccsc.makeRmiRequestEventManagerRemoveEvent(managerClientID, requestType,
			 eventID, eventType);
			...
			while (true) {
			 ...
			 emccsc.makeRmiRequestEventManagerBookEvent(managerClientID, customerClientID,
			 requestType, eventID, eventType);

		} else if (requestType == RequestType.GET_BOOKING_SCHEDULE) {
			System.out.println("enter customer id: ");
			customerClientID = sc.next();
			 emccsc.makeRmiRequestEventManagerGetBookingSchedule(managerClientID,customerClientID,
			 requestType);
			...
			while (true) {
			 ...
			 emccsc.makeRmiRequestEventManagerCancelEvent(managerClientID,
			 customerClientID, requestType, eventID, eventType);
